...
class OrderItem(AssemblyMixin):
    ...
    components: List[OrderComponent] = attr.ib(converter=convert_iterable(OrderComponent))
    ...
    ordered_add_ons: List[OrderedAddOn] = attr.ib(converter=convert_iterable(OrderedAddOn))
