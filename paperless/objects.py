...
class Address:
    ...
    country = attr.ib(validator=attr.validators.instance_of(str)) #TODO: DO I WANT this to be enumeration of countries?
    first_name = attr.ib(validator=attr.validators.instance_of(str)) #TODO: Do I want to just do recipient?
    ...
    phone = attr.ib(validator=attr.validators.instance_of(str))  # TODO: MAP EXTENSION IN THIS?
...
class OrderItem:
    ...
    price = attr.ib(validator=attr.validators.instance_of(str))
    ...
    unit_price = attr.ib(validator=attr.validators.instance_of(str))
    #finishes = attr.ib() #TODO: DO WE NEED THIS?


@attr.s(frozen=True)
class PaymentDetails:
    net_payout = attr.ib(validator=attr.validators.optional(attr.validators.instance_of(str)))
    ...
    shipping_cost = attr.ib(validator=attr.validators.instance_of(str))
    tax_cost = attr.ib(validator=attr.validators.optional(attr.validators.instance_of(str)))
    tax_rate = attr.ib(validator=attr.validators.optional(attr.validators.instance_of(str)))
...
class Order:
    ...
    number = attr.ib() #TODO: TYPING FOR THIS
